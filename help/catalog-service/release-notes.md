...
![新](../assets/new.svg)目錄服務現在支援產品Recommendations的[`recommendations`](https://developer.adobe.com/commerce/services/graphql/recommendations/recommendations/) GraphQL查詢。
...
![新](../assets/new.svg)目錄服務現在支援Adobe的[API網格](https://developer.adobe.com/graphql-mesh-gateway/)。
