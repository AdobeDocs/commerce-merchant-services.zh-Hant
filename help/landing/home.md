...
<tr style="border: 0;">
   ...
   <td valign="top">
      ...
      <div>
         <a href="../product-recommendations/overview.md">
         <strong>產品Recommendations</strong>
         </a>
      </div>
      <p>
...
>[!NOTE]
>
>Commerce商家可使用具有有效授權的Recommendations v6.0.0、Live Search v4.1.0或目錄服務v1.17，不需額外付費即可使用資料管理儀表板。 使用舊版服務的商家可以使用[目錄同步](../landing/catalog-sync.md)來管理和追蹤資料同步。
