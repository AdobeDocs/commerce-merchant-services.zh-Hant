...
1. 選取您從伺服器對伺服器執行的授權方法 **Adobe Developer授權型別** 功能表。 Adobe建議使用OAuth。 已棄用JWT。 [深入了解](https://developer.adobe.com/developer-console/docs/guides/authentication/ServerToServerAuthentication/migration/).
