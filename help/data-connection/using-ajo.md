...
Adobe[!DNL Commerce]客戶已透過使用Adobe[!DNL Commerce]、Adobe[!DNL Journey Optimizer]和Adobe[!DNL Real-Time CDP]實作個人化放棄行銷活動，取得顯著的業務影響。
...
>[!IMPORTANT]
>
>為了示範，請使用您的[!DNL Commerce]沙箱環境，這樣您就不會因為傳送給Experience Platform的店面和後台事件資料而稀釋生產事件資料。
...
1. 在您的[!DNL Commerce]沙箱環境中登入或建立帳戶。
   ...
   安裝並設定[!DNL Data Connection]擴充功能後，此帳戶資訊會以設定檔傳送給Experience Platform。

1. 確認您的使用者帳戶資訊出現在Experience Platform的&#x200B;**[!UICONTROL Profile]**&#x200B;區段中。
