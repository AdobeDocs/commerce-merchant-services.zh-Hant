...
<li>如果未選取某些項目，請確認 [!UICONTROL Ready for Pickup] 此時將顯示「零挑庫或退款」部分的電子郵件。 <code>DISPLAY COMMENT HISTORY</code> 顯示 <code>Order is ready for pickup, but some items not available.</code>。</li>
<li><code>CUSTOMER NOTIFIED</code> 標誌 <code>true</code>。</li>
</ul>
</td>
</tr>
...
<li>下訂單。</li>
<li>請等待訂單同步。</li>
<li>如果配置了授權和捕獲選項，請驗證是否已建立發票以及客戶是否收到了發票電子郵件。</li>
...
<td>單個和多數量物料。 無無挑庫和彎邊裝貨（帶分段）</td>
<td></td>
</tr>
<tr>
<td><strong>單個訂單領料 — 店內快捷路徑提貨</strong></td>
<td>單個和多數量物料。 無零提貨，店內提貨（帶暫存）</td>
<td>
</td>
</tr>
<tr>
<td><strong>多訂單領料 — 快樂路徑，店內領料</strong></td>
<td>挑選單個和多數量物料。 無無提貨，也無彎邊提貨（帶分段）。</td>
<td></td>
</tr>
<tr>
<td><strong>單訂單領料 — 不快樂路徑，店內提貨</strong></td>
<td>挑選單件和多件物料，包括部分和零件挑庫和存中裝貨（帶暫存）</td>
</td>
<td></td>
</tr>
...
<td>挑選單件和多件物料，包括部分和零件挑庫和曲邊拾取（帶分段）</strong></td>
</td>
<td></td>
</tr>
