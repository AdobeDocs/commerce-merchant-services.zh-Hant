...
![修正](../assets/fix.svg)<!-- Issue PAY-5396 --> Payment Services現在支援 [Adobe Commerce指南 `--db-prefix` 引數](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/advanced#install-from-the-command-line) 適用於Adobe Commerce 2.4.7版及更新版本。
...
![修正](../assets/fix.svg)<!-- PAY-5322 --> 已修正較新Adobe Commerce版本的PCI相容性問題。 現在，Payment Services已改編為Adobe Commerce中的結帳要求，作為付款選項。
...
![修正](../assets/fix.svg)<!-- PAY-5253 --> 修正無法刪除不屬於付款服務的儲存庫權杖的錯誤。
...
![新增](../assets/new.svg)<!-- PAY-4381 --> [Payment Services現在支援GraphQL整合](https://developer.adobe.com/commerce/webapi/graphql/payment-services/). 透過GraphQL對PayPal支付按鈕、託管欄位和Apple Pay的支援，支付服務現在可支援Headless Commerce設定。
